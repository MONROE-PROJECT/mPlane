...
sed -i '/\/tmp\/runtime.conf/c\runtimeconf = \/opt\/monroe-mplane\/tstat-conf\/runtime.conf' $protocol_ri_path$relative_path_to_conf$conf_file
sed -i '/\/rrdfiles\//c\tstat_rrd_path = \/opt\/monroe-mplane\/tstat-rrd\/rrd_tstat\/' $protocol_ri_path$relative_path_to_conf$conf_file
